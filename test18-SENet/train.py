...
def main():
    ...
    cifar10_train_loader = torch.utils.data.DataLoader(cifar10_train, batch_size=28, shuffle=True)
    cifar10_val_loader = torch.utils.data.DataLoader(cifar10_val, batch_size=28, shuffle=True)
